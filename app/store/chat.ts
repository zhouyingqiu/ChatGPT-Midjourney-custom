...
import { guid, prettyObject } from "../utils/format";
          ...
          return {
            ...
            ...(accState.freeType === 2
              ? {
                  id: guid(),
                  p_id:
                    lastReciveMessage && lastReciveMessage.free_attr?.id
                      ? lastReciveMessage.free_attr?.id
                      : guid(),
                  conversation_id:
                    lastReciveMessage &&
                    lastReciveMessage.free_attr?.conversation_id
                      ? lastReciveMessage.free_attr?.conversation_id
                      : undefined,
                }
              : {}),
      ...
      async onUserInput(content, extAttr?: any) {
        ...
        if (
          ...
          api.llm.chat({
            ...
            onUpdate(message, chunk, freeAttr = {}) {
